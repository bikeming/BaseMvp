...
//    public static final int noneNet=-1;
    ...
    public static boolean isNetworkConnected() {
        ...
        ConnectivityManager mConnectivityManager = (ConnectivityManager) MApp.getINSTANCE()
...
//    }
    ...
    public static NetworkInfo[] getWorkInfos() {
        ConnectivityManager cm = (ConnectivityManager) MApp.getINSTANCE().getSystemService(Context.CONNECTIVITY_SERVICE);
